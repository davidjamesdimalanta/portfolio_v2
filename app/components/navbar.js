        ...
        <Link href={"/"}>
          <svg width="28.782" height="32.668" version="1.1" viewBox="0 0 6.028 6.527" xmlns="http://www.w3.org/2000/svg" className='hover:cursor-pointer'>
              <g clipRule="evenodd" fill="#fffdd0" fillRule="evenodd" imageRendering="optimizeQuality" shapeRendering="geometricPrecision">
                <path className="UnoptimicedTransforms" transform="matrix(.01142 0 0 .01142 -2.884 -2.644)" d="m459.5 231.5c31.383 2.5782 60.024 32.691 55.617 65.125 0.11405 77.946 1.4078 156-0.85811 233.88-6.064 55.665-54.357 105.68-111.76 105.61-39.998 0.54715-80.003 0.50804-120-0.11725-13.389-14.401-34.478-46.081-25.391-59.471 49.095-0.22299 98.397 0.94676 147.35-1.9123 33.851-5.0332 52.652-38.996 55.023-70.465 1.4841-90.81 0.31863-181.78 0.0145-272.65z" fill="#fffdd0"/>
            ...
            <div className='hidden md:flex flex-grow justify-end items-center gap-4'>
                <Link href="/#about" className='hover:text-[#B2AC88]'>
                  About
                </Link>
                <Link href="/#projects" className='hover:text-[#B2AC88]'>
                  Projects
                </Link>
                <Link href="/#contact" className='hover:text-[#B2AC88]'>
                  Contact
                </Link>
            ...
            <div className='w-3/5 h-screen bg-[#143306] flex flex-col justify-start items-end p-6 gap-2 animate-slide'>
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                fill="none" 
                viewBox="0 0 24 24" 
              ...
              <ul className='w-full h-auto flex flex-col items-end text-xl gap-4 pt-4'>
                <li><a href='/David James Dimalanta Resume.pdf' className='hover:text-[#FFFDD0]' download><button>Resume</button></a></li>
              </ul>
            </div>
          </div>
          )}
