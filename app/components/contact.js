                ...
                <div className="w-full h-max flex flex-col justify-center items-start gap-2">
                    ...
                    <div className="flex gap-4">
                        <a href="mailto:david.dimalanta@mail.utoronto.ca">
                            <button className=" text-[#FFFDD0] border-[#FFFDD0] rounded-md border-2 px-4 py-2 hover:scale-105 ease-in-out" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="1000" data-aos-anchor="#contact-text">
                                Say Hi!
                            </button>
                        </a>
                        <a href="/David James Dimalanta Resume.pdf" download>
                            <button className=" text-[#FFFDD0] border-[#FFFDD0] rounded-md border-2 px-4 py-2 hover:scale-105 ease-in-out" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="1100" data-aos-anchor="#contact-text">
                                CV
                            </button>
                        </a>
                        <a href="/2023CV.pdf" className="hidden md:block" download>
                            <button className=" text-[#FFFDD0] border-[#FFFDD0] rounded-md border-2 px-4 py-2 hover:scale-105 ease-in-out" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="1200" data-aos-anchor="#contact-text">
                                CV (LaTeX)
                            </button>
                        </a>
                    </div>
                    <div className="flex gap-4 pt-4 md:pt-2">
                        ...
                        <a href="https://www.linkedin.com/in/david-james-dimalanta/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-delay="1400" data-aos-anchor="#contact">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                role="img" 
                                viewBox="0 0 24 24" 
